        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-white">
                    <div class="row">
                        <div class="col-3">
                            <img src="@if (empty($company->photo)){{url('img/nocompany.png')}}@else{{url('')}}/users/thumbnail/{{$company->photo}} @endif" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 140px;">
                        </div>
                        <div class="col-9">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
            <div class="card h-100 card-lift--hover shadow border-0">
                <a href="#"><img class="card-img-top card-img-sm" src="{{url('')}}/img/product/thumbnail/{{$p->image}}" alt=""></a>
                <div class="card-body">
                    <a href="{{route('companyproduct',['id'=>$p->productid])}}"><h4 class="h3 text-success text-uppercase">{{$p->productname}}</h4></a>

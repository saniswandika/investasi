            ...
            <form action="{{route('searchcompanies')}}">
                <div class="row">
                    <div class="col-lg-12 text-white">
                        <h1 class="display-3 text-white">@lang('front.companies-Companies')</h1>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group w-100">
                            <label for="" class="text-white">@lang('front.companies-Find')</label>
                            <input type="text"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="" class="text-white">@lang('front.companies-Company Sector')</label>
                            <select class="form-control" name="sectors" id="" placeholder="All">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="" class="text-white">@lang('front.companies-Company Field')</label>
                            <select class="form-control" name="field" id="" placeholder="All">
                    ...
                    <div class="col-lg-2 pt-4">
                        <button type="submit" class="btn btn-primary mt-2">@lang('front.companies-Search')</button>
                    </div>
                </div>
            </form>
        </div>

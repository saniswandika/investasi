                ...
                <form action="{{route('users.update',['id'=>$user->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Users</h3>
                            <a href="{{route('users.index')}}" class="btn btn-sm btn-primary ml-auto">Back</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="mb-3"><img class="img-thumbnail" src="@if (empty($user->photo))
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                      class="form-control my-editor">{!! old('deskripsi',$user->description) !!}</textarea>
                        </div>

...
@section('title')
    Halaman Tambah New Industrial Zone
@stop
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('industri-new.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="PT. BIJB" value="{!! old('name') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="number"
                                               ...
                                               placeholder="14000" value="{!! old('area') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-6">Long: <input name="long" id="lng" type="text" class="form-control" value="{!! old('lang') !!} required" id="exampleFormControlInput1"></div>
                                            <div class="col-lg-6">Lat: <input name="lat" id="lat" type="text" class="form-control" value="{!! old('lat') !!} required" id="exampleFormControlInput1"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('artikel.update',['art_id'=>$artikel->art_id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data Artikel</h3>
                    ...
                    <div class="card-body">
                        <div class="p-4">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select class="form-control" name="lang_type" value="{!! old('lang_type') !!}">
                                            <option value="{{$artikel->lang_type}}">
                                                @if($artikel->lang_type == 'id')
                                                    Indonesia
                                                @elseif($artikel->lang_type == 'en')
                                                    Inggris
                                                @else
                                                    No Language
                                                @endif
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="artikel 1" value="{!! old('judul',$artikel->judul) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($artikel->image))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/artikel/thumbnail/{{$artikel->image}}
                                            @endif"></div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="konten" rows="15"
                                            class="form-control my-editor">{!! old('konten',$artikel->konten) !!}</textarea>
                                    </div>
                                </div>
                            </div>

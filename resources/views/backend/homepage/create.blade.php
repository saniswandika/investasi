                        ...
                        <div class="p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           class="form-control" name="bannerText" id="" aria-describedby="helpId"
                                           placeholder="banner Text" value="{!! old('bannerText') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="file" class="form-control-file" name="findInvestmentImage" id="" placeholder=""
                                           aria-describedby="fileHelpId">
                                        <small>*max 2 mb</small>
                                    </div>
                                </div>

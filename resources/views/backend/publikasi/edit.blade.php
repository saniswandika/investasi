...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('publikasi.update',['pub_id'=>$publikasi->pub_id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data Publikasi</h3>
                        ...
                        <div class="p-4">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="publikasi 1" value="{!! old('judul',$publikasi->judul) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3">
                                            <a class="btn btn-primary mb-3" href="{{url('')}}/file/publikasi/{{$publikasi->file}}" target="_blank">Download File</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($publikasi->image))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/pub/thumbnail/{{$publikasi->image}}
                                            @endif"></div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="deskripsi" rows="20"
                                            class="form-control my-editor">{!! old('deskripsi',$publikasi->deskripsi) !!}</textarea>
                                    </div>
                                </div>
                            </div>

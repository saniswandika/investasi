...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('fintech.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Tambah Fintech</h3>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="fintech 1" value="{!! old('nama_fintech') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="Lokasi Fintech" value="{!! old('lokasi_fintech') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="https://fintech.id" value="{!! old('website') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="PT. Fintech Indonesia" value="{!! old('perusahaan') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="Nomor Register" value="{!! old('register') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control datepicker" placeholder="Select date" name="tanggal_reg" type="text" value="2020-06-04">
                                        </div>
                                    </div>
                                </div>
                            </div>

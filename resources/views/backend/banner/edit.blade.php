                ...
                <div class="card-body">
                    <div class="p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="menu" id="menu" placeholder="menu Text" value="{!! old('title', $banner->menu) !!}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($banner->image))

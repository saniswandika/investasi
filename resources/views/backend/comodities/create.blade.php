...
@section('title')
    Halaman Tambah Trading Commodities
@stop
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('comodities.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="resources" {{ old('type') == 'resource' ? 'selected' : '' }}>Resources</option>
                                            <option value="coffee" {{ old('type') == 'coffee' ? 'selected' : '' }}>Coffee</option>
                                            <option value="fruits" {{ old('type') == 'fruit' ? 'selected' : '' }}>Fruits</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="Tea" value="{!! old('name') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="14000" value="{!! old('plant_area') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="14000" value="{!! old('production') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

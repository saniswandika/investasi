...
@section('title')
    Halaman Edit Trading Commodities
@stop
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('comodities.update',['id'=>$comodities->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data</h3>
                            <a href="{{route('comodities.index')}}" class="btn btn-sm btn-primary ml-auto">Back</a>
                    ...
                    <div class="card-body">
                        <div class="p-4">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="type" class="form-control">
                                            <option value="resources" {{ old('type', $comodities->type) == 'resources' ? 'selected' : '' }}>Resources</option>
                                            <option value="coffee" {{ old('type', $comodities->type) == 'coffee' ? 'selected' : '' }}>Coffee</option>
                                            <option value="fruits" {{ old('type', $comodities->type) == 'fruits' ? 'selected' : '' }}>Fruits</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="PT. BIJB" value="{!! old('name', $comodities->name) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               class="form-control" name="plant_area" id="" aria-describedby="helpId"
                                               placeholder="14000" value="{!! old('plant_area', $comodities->plant_area) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               class="form-control" name="production" id="" aria-describedby="helpId"
                                               placeholder="14000" value="{!! old('production', $comodities->production) !!}">
                                    </div>
                                </div>
                            </div>
                            @if($comodities->location == null)
                            @else
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="searchmap" name="location" value="{!! old('location', $comodities->location) !!}"><br>
                                        <div id="map-canvas"></div>
                                        <div class="row mt-2">
                                            <div class="col-lg-6">Long: <input name="long" id="lng" type="text" class="form-control" value="{!! old('long', $comodities->long) !!}" id="exampleFormControlInput1"></div>
                                            <div class="col-lg-6">Lat: <input name="lat" id="lat" type="text" class="form-control" value="{!! old('lat', $comodities->lat) !!}" id="exampleFormControlInput1"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($comodities->image))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/commodities/thumbnail/{{$comodities->image}}
                                            @endif"></div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="https://investasi.jabarprov.go.id" value="{!! old('link', $comodities->link) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="desc"
                                                  class="form-control my-editor">{!! old('desc', $comodities->desc) !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
@section('bottom-content')
	...
	$(function() {
      ...
      function success(position) {
        // Inisiasi Variabel
        var map, marker,
                	latitude = <?php echo $comodities['lat']; ?>,
        	longitude = <?php echo $comodities['long']; ?>;

...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('wjisRegistration.update',['Id'=>$wjisRegistration->Id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data WJIS Registration</h3>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="name" value="{!! old('name',$wjisRegistration->name) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="email" value="{!! old('email',$wjisRegistration->email) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="position" value="{!! old('position',$wjisRegistration->position) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           class="form-control" name="company" id="" aria-describedby="helpId"
                                           value="{!! old('company',$wjisRegistration->company) !!}">
                                    </div>
                                </div>
                            </div>

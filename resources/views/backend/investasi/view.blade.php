            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <a href="{{ route('investasi.edit', ['invest_id' => $investasi->invest_id]) }}"
                ...
                <div class="p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <img class="img-thumbnail"
                                    src="@if (empty($investasi->support_file)) No File Detected
                                    @else
                                    {{ url('') }}/investasi/thumbnail/{{ $investasi->support_file }} @endif"
                                    alt="">
                            </div>
                        </div>
                    </div>

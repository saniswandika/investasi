...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('tourism.update',['id'=>$tourism->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data</h3>
                            <a href="{{route('tourism.index')}}" class="btn btn-sm btn-primary ml-auto">Back</a>
                    ...
                    <div class="card-body">
                        <div class="p-4">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="Tourism Map Profile" {{ old('type', $tourism->type) == 'Tourism Map Profile' ? 'selected' : '' }}>Tourism Map Profile</option>
                                            <option value="Future Tourism Development" {{ old('type', $tourism->type) == 'Future Tourism Development' ? 'selected' : '' }}>Future Tourism Development</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="PT. BIJB" value="{!! old('name', $tourism->name) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="category" class="form-control">
                                            ...
                                            <option value="Natural Tourism" {{ old('category', $tourism->category) == 'Natural Tourism' ? 'selected' : '' }}>Natural Tourism</option>
                                            <option value="Cultural Tourism" {{ old('category', $tourism->category) == 'Cultural Tourism' ? 'selected' : '' }}>Cultural Tourism</option>
                                            <option value="Education Tourism" {{ old('category', $tourism->category) == 'Education Tourism' ? 'selected' : '' }}>Education Tourism</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="searchmap" name="location" value="{!! old('location', $tourism->location) !!}"><br>
                                        <div id="map-canvas"></div>
                                        <div class="row mt-2">
                                            <div class="col-lg-6">Long: <input name="long" id="lng" type="text" class="form-control" value="{!! old('long', $tourism->long) !!}" id="exampleFormControlInput1"></div>
                                            <div class="col-lg-6">Lat: <input name="lat" id="lat" type="text" class="form-control" value="{!! old('lat', $tourism->lat) !!}" id="exampleFormControlInput1"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($tourism->image))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/tourism/thumbnail/{{$tourism->image}}
                                            @endif"></div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="https://investasi.jabarprov.go.id" value="{!! old('link', $tourism->link) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="desc"
                                                  class="form-control my-editor">{!! old('desc', $tourism->desc) !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
@section('bottom-content')
	...
	$(function() {
      ...
      function success(position) {
        // Inisiasi Variabel
        var map, marker,
                	latitude = <?php echo $tourism['lat']; ?>,
        	longitude = <?php echo $tourism['long']; ?>;

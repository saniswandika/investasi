                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="Tourism Map Profile" {{ old('type') == 'Tourism Map Profile' ? 'selected' : '' }}>Tourism Map Profile</option>
                                            <option value="Future Tourism Development" {{ old('type') == 'Future Tourism Development' ? 'selected' : '' }}>Future Tourism Development</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="Kawah Putih Lake" value="{!! old('name') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select name="category" class="form-control">
                                            ...
                                            <option value="Natural Tourism" {{ old('type') == 'Natural Tourism' ? 'selected' : '' }}>Natural Tourism</option>
                                            <option value="Cultural Tourism" {{ old('type') == 'Cultural Tourism' ? 'selected' : '' }}>Cultural Tourism</option>
                                            <option value="Education Tourism" {{ old('type') == 'Education Tourism' ? 'selected' : '' }}>Education Tourism</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="https://investasi.jabarprov.go.id" value="{!! old('link') !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

...
@section('title')
    Halaman Daftar West Java Sector Management
@stop
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-row align-items-center">
                        <h3>Halaman Daftar West Java Sector Management</h3>
                        <a href="/../public/westjavasectormanagement/create" class="btn btn-sm btn-primary ml-auto">Tambah Konten Sector Management</a>
                    </div>
                </div>
                    ...
                    <table class="table table-flush" id="datatable-buttons">
                        ...
                        <tr>
                                ...
                                <td><img class="img-table" src="@if (empty($a->image))
                                    ...
                                    @else
                                    {{url('')}}/img/westjavasectormanagement/thumbnail/{{$a->image}}
                                    @endif" alt=""></td>
                                <td>@if($a->isBahasa == 0)
                                        Indonesia
                                    @elseif($a->isBahasa == 1)
                                ...
                                <td>{{ $a->isActive }}</td>
                                <td>
                                    <a href="{{route('westjavasectormanagement.show',['Id'=>$a->Id])}}" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a href="{{ route('westjavasectormanagement.edit', ['Id' => $a->Id]) }}" class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <a href="{{route('westjavasectormanagement.destroy',['Id'=>$a->Id])}}" class="btn btn-danger" onclick="return confirm('are you sure want to delete ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

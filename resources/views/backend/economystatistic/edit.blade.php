...
@section('title')
    Halaman Edit Economiy Statistic
@stop
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('economyStatistic.update',['Id'=>$economyStatistic->Id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data Economy Statistic</h3>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="inflation" value="{!! old('inflation',$economyStatistic->inflation) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="date"
                                           ...
                                           value="{!! old('inflationDate',$economyStatistic->inflationDate) !!}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="Economic Growth" value="{!! old('economicGrowth',$economyStatistic->economicGrowth) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="date"
                                           ...
                                           value="{!! old('economicGrowthDate',$economyStatistic->economicGrowthDate) !!}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                           ...
                                           placeholder="westJavaExport" value="{!! old('westJavaExport',$economyStatistic->westJavaExport) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="date"
                                           ...
                                           value="{!! old('westJavaExportDate',$economyStatistic->westJavaExportDate) !!}">
                                    </div>
                                </div>
                            </div>

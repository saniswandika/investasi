            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-row align-items-center">
                        <h3>Halaman Economy Graphic</h3>
                        <a href="/../public/economyGraphic/create" class="btn btn-sm btn-primary ml-auto">Tambah Konten</a>
                    </div>
                </div>
                    ...
                    <table class="table table-flush" id="datatable-buttons">
                        ...
                        @foreach($economyGraphic as $a)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('economyGraphic.show',['Id'=>$a->Id])}}" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a href="{{route('economyGraphic.edit',['Id'=>$a->Id])}}" class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <a href="{{route('economyGraphic.destroy',['Id'=>$a->Id])}}" class="btn btn-danger" onclick="return confirm('are you sure want to delete ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

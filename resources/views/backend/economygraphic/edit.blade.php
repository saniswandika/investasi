...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('economyGraphic.update', ['Id' => $economyGraphic->Id]) }}" method="POST"
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data Economy Graphic</h3>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="value" id=""
                                            aria-describedby="helpId" placeholder="value" value="{!! old('value', $economyGraphic->value) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="date" class="form-control" name="date" id=""
                                            aria-describedby="helpId" value="{!! old('date', $economyGraphic->date) !!}">
                                    </div>
                                </div>
                            </div>

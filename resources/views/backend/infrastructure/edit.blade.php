...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('infrastructure.update',['id'=>$inf->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data infrastructure</h3>
                            <a href="{{route('infrastructure.index')}}" class="btn btn-sm btn-primary ml-auto">Back</a>
                    ...
                    <div class="card-body">
                        <div class="p-4">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select class="form-control" name="inf_category">
                                                <option value="{{$inf->catid}}">{{$inf->catname}}</option>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select class="form-control" name="subcategory">
                                            <option value="{{$inf->subcatid}}">{{$inf->subcatname}}</option>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select class="form-control" name="status">
                                                <option value="{{$inf->idstatus}}">{{$inf->namestatus}}</option>
                                            @foreach($status as $s)
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="Padalarang-Cileunyi" value="{!! old('name', $inf->name) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="www.investasi.jabarprov.go.id" value="{!! old('link', $inf->link) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               class="form-control" name="detail" id="" aria-describedby="helpId"
                                               placeholder="" value="{!! old('detail', $inf->detail) !!}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <select class="form-control" name="geotype">
                                            <option value="{{$inf->geotype}}">{{$inf->geotype}}</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="searchmap" value="Cari"><br>
                                        <div id="map-canvas"></div>
                                        <div class="row mt-2">
                                            <div class="col-lg-6">Long: <input name="long" id="lng" type="text" class="form-control" value="{!! old('long',$inf->long) !!}" id="exampleFormControlInput1"></div>
                                            <div class="col-lg-6">Lat: <input name="lat" id="lat" type="text" class="form-control" value="{!! old('lat',$inf->lat) !!}" id="exampleFormControlInput1"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('bottom-content')
	...
	$(function() {
      ...
      function success(position) {
        // Inisiasi Variabel
        var map, marker,
                	latitude = <?php echo $inf['lat']; ?>,
        	longitude = <?php echo $inf['long']; ?>;

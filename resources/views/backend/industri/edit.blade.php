...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('industri.update',['id'=>$industri->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card-header">
                        <div class="d-flex flex-row align-items-center">
                            <h3>Update Data industri</h3>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="Kawasan Industri Jawa Barat" value="{!! old('name', $industri->name) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="KIJB" value="{!! old('code', $industri->code) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-lg-6">Lat: <input name="lat" id="lat" type="text" class="form-control" value="{!! old('long',$industri->lat) !!}" id="exampleFormControlInput1"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($industri->image2))
                                                            {{url('img/default-image.png')}}
                                                            @else
                                                            {{url('')}}/img/industry/thumbnail/{{$industri->image2}}
                                                            @endif"></div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($industri->image))
                                                            {{url('img/default-image.png')}}
                                                            @else
                                                            {{url('')}}/img/industry/thumbnail/{{$industri->image}}
                                                            @endif"></div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="PT. Bogorindo Cemerlang" value="{!! old('company_name',$industri->company_name) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="Jl. Olympic Raya Kavling B, Sentul, Bogor 16810" value="{!! old('office_address',$industri->office_address) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('phone', $industri->phone) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('fax', $industri->fax) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('website', $industri->website) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('email', $industri->email) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('presdir', $industri->presdir) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('director', $industri->director) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('contact_person', $industri->contact_person) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="33 km south direction via Jagorawi toll road" value="{!! old('distance_to_jkt', $industri->distance_to_jkt) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="Tanjung Priok 50km" value="{!! old('distance_to_harbour', $industri->distance_to_harbour) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="Soekarno-Hatta 70km" value="{!! old('distance_to_airport', $industri->distance_to_airport) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('total_area', $industri->total_area) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('total_develop_area', $industri->total_develop_area) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('total_salable_area', $industri->total_salable_area) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('total_available_area', $industri->total_available_area) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('facilities', $industri->facilities) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_ws_source', $industri->ui_ws_source) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_ws_capacity', $industri->ui_ws_capacity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_el_source', $industri->ui_el_source) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_el_capacity', $industri->ui_el_capacity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_tel_source', $industri->ui_tel_source) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_tel_capacity', $industri->ui_tel_capacity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_fo_source', $industri->ui_fo_source) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_fo_capacity', $industri->ui_fo_capacity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_gas_source', $industri->ui_gas_source) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ui_gas_capacity', $industri->ui_gas_capacity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_selling_industrial_land', $industri->ei_selling_industrial_land) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_selling_warehouse', $industri->ei_selling_warehouse) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_service', $industri->ei_charge_service) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_water', $industri->ei_charge_water) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_electricity', $industri->ei_charge_electricity) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_gas', $industri->ei_charge_gas) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_tel', $industri->ei_charge_tel) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('ei_charge_fo', $industri->ei_charge_fo) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text"
                                                               ...
                                                               placeholder="" value="{!! old('number_oc', $industri->number_oc) !!}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                    ...
                    <div class="card-body">
                        <div class="p-4">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               placeholder="Kota Bandung" value="{!! old('name', $profile->name) !!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($profile->image))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/profile/thumbnail/{{$profile->image}}
                                            @endif"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="mb-3"><img class="img-thumbnail" src="@if (empty($profile->peta))
                                            {{url('img/default-image.png')}}
                                            @else
                                            {{url('')}}/img/profile/thumbnail/{{$profile->peta}}
                                            @endif"></div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="desc" rows="20"
                                                  class="form-control my-editor">{!! old('desc', $profile->desc) !!}</textarea>
                                    </div>
                                </div>
                            </div>
